...
class Post(tk.Frame):
    def __init__(self, container, id, title, image, caption, parent):
        ...
        #MAIN_FRAME
        self.title_text = tk.Text(main_frame, height=1, width=40)
        ...
        self.caption_text = tk.Text(main_frame, height= 8, width=40)
        ...
        self.init_post(title, caption)

    def init_post(self, title, caption):
    ...
    def on_save(self):
        ...
        self.caption = self.caption.rstrip()
        self.on_cancel()
        post_data = JsonController.get_posts_data()
        post_data[self.id]["title"]= self.title
        post_data[self.id]["caption"] = self.caption
        JsonController.set_posts_data(post_data)
