...
class PathsController:
    ...
    def get_path(dest:str):
        ...
        if dest == "webpage_html":
            return JsonController.get_config_data("active_html_webpage")
...
class HtmlController:
    ...
    def get_webpage_html()->bs:
        html_webpage:bs = HtmlModel.open_html(JsonController.get_config_data("active_html_webpage"))
        if not html_webpage:
    ...
    def set_webpage_html(html):
        HtmlModel.write_html_file(JsonController.get_config_data("active_html_webpage"), html)
    ...
    def update_header(component_path):
        ...
        HtmlModel.write_html_file(JsonController.get_config_data("active_html_webpage"), html_webpage)
...
class PostController:     
    ...
    def update_post(id:str, title:str = None, caption:str = None):
        ...
        HtmlModel.write_html_file(JsonController.get_config_data("active_html_webpage"), webpage_html)
        Controller.push_to_git()
